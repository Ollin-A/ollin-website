...
const PersonalizedPackageHero: React.FC = () => {
    ...
    return (
        <section className="bg-transparent">
            <div className="mx-auto max-w-[1100px] px-6 pt-10 md:pt-12 pb-2 md:pb-3">
                <h1 className="text-center font-medium tracking-[-0.06em] text-black select-none">
                    {/* Line 1 */}
                    <span className="block leading-[0.95] text-[clamp(44px,6vw,86px)]">
                        Build your
                    </span>
                    ...
                    {/* Line 3 */}
                    <span className="block mt-2 md:mt-3 leading-[0.95] text-[clamp(44px,6vw,86px)]">
                        plan
                    </span>
                </h1>
            </div>
