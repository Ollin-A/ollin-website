      ...
      <section className="w-full max-w-[1500px] mx-auto px-[5vw] pt-28 md:pt-32 pb-10 md:pb-14">
        ...
        <div className="mt-10 md:mt-12">
          ...
          <p className="mt-4 text-[15px] md:text-[17px] leading-relaxed text-ollin-black/70 max-w-[75ch]">
            Retention is where growth becomes durable: leads don’t get wasted,
            jobs turn into reviews, and past customers come back when
            seasonality hits.
          </p>
            ...
            <div className="col-span-12 md:col-span-7">
              <div className="rounded-[22px] border border-black/10 bg-white/35 p-7 md:p-9">
                ...
                <p className="text-[15px] md:text-[17px] leading-relaxed text-ollin-black/75">
                  Digital Secretary exists to stop the classic leak: slow
                  replies, missed calls, and “I’ll get back to you” leads that
                  vanish.
                </p>
                ...
                <div className="mt-6 space-y-3 text-[14px] md:text-[15px] leading-relaxed text-ollin-black/70">
                  <p>
                    ...
                    asks the right questions and routes leads to the right next
                    step.
                  </p>
                  <p>
                    <span className="font-medium text-ollin-black/80">
                    ...
                    helps move from “DM” to a scheduled call/visit when the
                    workflow allows.
                  </p>
                  <p>
                    <span className="font-medium text-ollin-black/80">
                    ...
                    Social is the front-end; Digital Secretary is the backend
                    for booking/quotes.
                  </p>
                </div>
              </div>
          ...
          <div className="mt-10 grid grid-cols-12 gap-8">
            <div className="col-span-12 md:col-span-7">
              <div className="rounded-[22px] border border-black/10 bg-white/35 p-7 md:p-9">
                ...
                <p className="text-[15px] md:text-[17px] leading-relaxed text-ollin-black/75">
                  This isn’t a spammy follow-up tool. It’s a reputation +
                  reactivation engine we operate: it asks for reviews at the
                  right moment, filters unhappy clients privately, and runs
                  reactivation when seasonality hits.
                </p>
                ...
                <div className="mt-6 space-y-3 text-[14px] md:text-[15px] leading-relaxed text-ollin-black/70">
                  <p>
                    ...
                    happy → direct to Google/Facebook; unhappy → private alert
                    first.
                  </p>
                  <p>
                    <span className="font-medium text-ollin-black/80">
                    ...
                    ask for referrals when the customer is happiest (timing
                    matters).
                  </p>
                  <p>
                    <span className="font-medium text-ollin-black/80">
          ...
          <div className="rounded-[26px] border border-black/10 bg-white/30 p-8 md:p-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
              ...
              <p className="mt-2 text-[14px] md:text-[15px] leading-relaxed text-ollin-black/65 max-w-[70ch]">
                We’ll map your intake + follow-up flow and recommend the
                smallest Retention stack that increases close rate and review
                velocity.
              </p>
            </div>
