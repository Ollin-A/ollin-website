      ...
      <section className="w-full max-w-[1500px] mx-auto px-[5vw] pt-28 md:pt-32 pb-10 md:pb-14">
        ...
        <div className="mt-10 md:mt-12">
          ...
          <p className="mt-4 text-[15px] md:text-[17px] leading-relaxed text-ollin-black/70 max-w-[75ch]">
            Demand is how you get steady opportunities: ads, Google Maps
            visibility, and tracking that shows what’s actually bringing real
            jobs — not just “likes” or pretty reports.
          </p>
            ...
            <div className="col-span-12 md:col-span-7">
              <div className="rounded-none border border-black/10 bg-white/35 p-7 md:p-9">
                ...
                <p className="text-[15px] md:text-[17px] leading-relaxed text-ollin-black/75">
                  This isn’t “turn it on and hope.” We set the plan, launch the
                  ads, check results weekly, tighten targeting, refresh
                  copy/creative, and protect your budget from junk leads.
                </p>
                ...
                <div className="mt-6 space-y-3 text-[14px] md:text-[15px] leading-relaxed text-ollin-black/70">
                  <p>
                    ...
                    strategy → build campaigns → weekly tune-ups → results
                    review → adjustments.
                  </p>
                  <p>
                    <span className="font-medium text-ollin-black/80">
            ...
            <div className="col-span-12 md:col-span-5">
              <div className="rounded-none border border-black/10 bg-white/20 p-7 md:p-9 h-full">
                ...
                <div className="space-y-3 text-[14px] md:text-[15px] leading-relaxed text-ollin-black/70">
                  ...
                  <p>
                    • Service areas where people are actively searching and
                    ready to hire.
                  </p>
          ...
          <div className="mt-10 grid grid-cols-12 gap-8">
            <div className="col-span-12 md:col-span-7">
              <div className="rounded-none border border-black/10 bg-white/35 p-7 md:p-9">
                ...
                <p className="text-[15px] md:text-[17px] leading-relaxed text-ollin-black/75">
                  We tighten up your Google profile, make sure your info matches
                  everywhere, and keep it active so it doesn’t look like you
                  stopped working.
                </p>
                ...
                <div className="mt-6 space-y-3 text-[14px] md:text-[15px] leading-relaxed text-ollin-black/70">
                  <p>
                    ...
                    profile cleanup, service list, description, hours, and a
                    solid photo set.
                  </p>
                  <p>
                    <span className="font-medium text-ollin-black/80">
                    ...
                    simple review-request templates + reasonable replies (so it
                    looks cared for).
                  </p>
                  <p>
                    <span className="font-medium text-ollin-black/80">
            ...
            <div className="col-span-12 md:col-span-5">
              <div className="rounded-none border border-black/10 bg-white/20 p-7 md:p-9 h-full">
                ...
                <div className="space-y-3 text-[14px] md:text-[15px] leading-relaxed text-ollin-black/70">
                  <p>
                    • Going hard in multiple cities is basically a
                    multi-location effort.
                  </p>
                  <p>
                    • Maps builds momentum — but only if the profile stays clean
                    and active.
                  </p>
                  <p>
                    • Reviews matter a lot (Retention helps you keep them
                    coming).
                  </p>
                </div>
              </div>
          ...
          <div className="mt-10 grid grid-cols-12 gap-8">
            <div className="col-span-12 md:col-span-7">
              <div className="rounded-none border border-black/10 bg-white/35 p-7 md:p-9">
                ...
                <p className="text-[15px] md:text-[17px] leading-relaxed text-ollin-black/75">
                  We set up tracking to answer the only questions that matter:
                  where leads came from, which ones were junk, and what actually
                  turned into booked work.
                </p>
                ...
                <div className="mt-6 space-y-3 text-[14px] md:text-[15px] leading-relaxed text-ollin-black/70">
                  ...
                  <p>
                    ...
                    if you track “won jobs,” we can tie marketing to revenue. If
                    not, we keep it at lead truth.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-span-12 md:col-span-5">
              <div className="rounded-none border border-black/10 bg-white/20 p-7 md:p-9 h-full">
                ...
                <div className="space-y-3 text-[14px] md:text-[15px] leading-relaxed text-ollin-black/70">
                  ...
                  <p>
                    • You stop chasing “cheap leads” and start chasing closed
                    jobs.
                  </p>
                </div>
              </div>
          ...
          <div className="rounded-none border border-black/10 bg-white/30 p-8 md:p-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
              ...
              <p className="mt-2 text-[14px] md:text-[15px] leading-relaxed text-ollin-black/65 max-w-[70ch]">
                Tell us your trade + service area, and how fast you answer
                leads. We’ll recommend the right mix (Ads / Maps / Tracking) to
                get you more calls without wasting spend.
              </p>
            </div>
