...
const PersonalizedPackageBuilder: React.FC<Props> = ({
    ...
    expanded,
    answers,
    preset: _preset, // kept for compatibility (UI removed)
    completeness: _completeness, // kept for compatibility (UI removed)
    setExpanded,
    toggleService,
    setFieldValue,
    summarizeService,
                                        ...
                                        <div className="flex-1">
                                            <div className="flex items-start justify-between gap-3">
                                                <div>
                                                    ...
                                                    <p className="mt-2 text-sm text-black/65 leading-relaxed max-w-[720px]">
                                                        {service.blurb}
                                                    </p>
                                                </div>
                ...
                {!mobileOpen && (
                    <div className="fixed bottom-4 left-4 right-4 z-50">
                        <button
                            ...
                            className="w-full rounded-3xl border border-black/10 bg-black text-white px-4 py-4 flex items-center justify-between"
                            aria-expanded={false}
                        >
                        ...
                        {/* CTA always present, disabled if empty */}
                        <button
                            type="button"
                            onClick={onOpenModal}
                            disabled={!canRequest}
                            className={cx(
                                "mt-3 w-full rounded-2xl px-4 py-4 text-base font-semibold transition",
                                !canRequest
