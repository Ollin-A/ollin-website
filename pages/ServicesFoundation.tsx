      ...
      <section className="w-full max-w-[1500px] mx-auto px-[5vw] pt-28 md:pt-32 pb-10 md:pb-14">
        ...
        <div className="mt-10 md:mt-12">
          ...
          <p className="mt-4 text-[15px] md:text-[17px] leading-relaxed text-ollin-black/70 max-w-[75ch]">
            This is the stuff people judge fast: your logo/branding, your
            website, and your social pages. When those look solid, you earn the
            first call.
          </p>
            ...
            <div className="col-span-12 md:col-span-7">
              <div className="rounded-none border border-black/10 bg-white/35 p-7 md:p-9">
                ...
                <p className="text-[15px] md:text-[17px] leading-relaxed text-ollin-black/75">
                  A simple brand kit you can actually use in the real world: a
                  clean logo that stays readable on a truck door, a hat, and
                  online — plus the exact files your printer/sign guy asks for.
                </p>

                <div className="mt-6 space-y-3 text-[14px] md:text-[15px] leading-relaxed text-ollin-black/70">
                  <p>
                    <span className="font-medium text-ollin-black/80">
                      Logo cleanup + versions:
                    </span>{" "}
                    main logo + alternate layouts + light/dark versions (so it
                  ...
                  <p>
                    ...
                    tested at small sizes for truck/yard sign/shirt use — no
                    “looks good only on a screen” stuff.
                  </p>
                  <p>
                    <span className="font-medium text-ollin-black/80">
                      Printer-ready handoff:
                    </span>{" "}
                    organized exports (PNG/SVG/PDF) so anyone can print it
            ...
            <div className="col-span-12 md:col-span-5">
              <div className="rounded-none border border-black/10 bg-white/20 p-7 md:p-9 h-full">
                ...
                <div className="space-y-3 text-[14px] md:text-[15px] leading-relaxed text-ollin-black/70">
                  <p>
                    • Your logo looks different on your website vs your truck vs
                    Facebook.
                  </p>
                  <p>• Your printer keeps asking for files you don’t have.</p>
                  <p>
                    • You’re about to run ads and you don’t want to look “new”
                    or messy.
                  </p>
                </div>
              </div>
          ...
          <div className="mt-10 grid grid-cols-12 gap-8">
            <div className="col-span-12 md:col-span-7">
              <div className="rounded-none border border-black/10 bg-white/35 p-7 md:p-9">
                ...
                <p className="text-[15px] md:text-[17px] leading-relaxed text-ollin-black/75">
                  We build (or tune up) contractor sites with the basics done
                  right: clear “call now” prompts, proof in the right places,
                  and lead forms that don’t break.
                </p>

                <div className="mt-6 space-y-3 text-[14px] md:text-[15px] leading-relaxed text-ollin-black/70">
                  <p>
                    <span className="font-medium text-ollin-black/80">
                      Leads that actually come in:
                    </span>{" "}
                    call/text buttons + forms that send to email and a Google
                    Sheet (with spam protection).
                  </p>
                  <p>
                    <span className="font-medium text-ollin-black/80">
                      Ad-ready tracking:
                    </span>{" "}
                    we set up Google/Meta tracking so your ads aren’t flying
                    blind (calls + form submits).
                  </p>
                  <p>
                    <span className="font-medium text-ollin-black/80">
                      Ongoing care (optional):
                    </span>{" "}
                    hosting, updates, backups, and small edits — so your site
            ...
            <div className="col-span-12 md:col-span-5">
              <div className="rounded-none border border-black/10 bg-white/20 p-7 md:p-9 h-full">
                ...
                <div className="space-y-3 text-[14px] md:text-[15px] leading-relaxed text-ollin-black/70">
                  ...
                  <p>
                    • “Pretty but unclear” pages that don’t tell people what to
                    do.
                  </p>
          ...
          <div className="mt-10 grid grid-cols-12 gap-8">
            <div className="col-span-12 md:col-span-7">
              <div className="rounded-none border border-black/10 bg-white/35 p-7 md:p-9">
                ...
                <p className="text-[15px] md:text-[17px] leading-relaxed text-ollin-black/75">
                  We keep your pages looking alive: steady posting, clean
                  visuals, and message/comment monitoring so you don’t look
                  abandoned.
                </p>
                ...
                <div className="mt-6 space-y-3 text-[14px] md:text-[15px] leading-relaxed text-ollin-black/70">
                  <p>
                    ...
                    monthly plan + content creation + scheduling (before/after,
                    reviews, jobs, tips).
                  </p>
                  <p>
                    <span className="font-medium text-ollin-black/80">
                    ...
                    branded templates + captions that sound human (EN/ES
                    available).
                  </p>
                  <p>
                    <span className="font-medium text-ollin-black/80">
                    ...
                    we don’t quote or book jobs inside Social — that’s handled
                    by Digital Secretary.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-span-12 md:col-span-5">
              <div className="rounded-none border border-black/10 bg-white/20 p-7 md:p-9 h-full">
                ...
                <div className="space-y-3 text-[14px] md:text-[15px] leading-relaxed text-ollin-black/70">
                  ...
                  <p>
                    • Messages get answered and routed fast (no more missed easy
                    leads).
                  </p>
                </div>
              </div>
          ...
          <div className="rounded-none border border-black/10 bg-white/30 p-8 md:p-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
              ...
              <p className="mt-2 text-[14px] md:text-[15px] leading-relaxed text-ollin-black/65 max-w-[70ch]">
                Tell us your trade + service areas and we’ll recommend the
                simplest Foundation setup to make you look established before
                you spend hard on ads.
              </p>
            </div>
